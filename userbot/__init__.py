...
while 0 < 6:
    _DEVS = get(
        "https://raw.githubusercontent.com/PXZUpLUK/Reforestation/master/DEVS.json"
    )
...
UPSTREAM_REPO_URL = os.environ.get(
    "UPSTREAM_REPO_URL", "https://github.com/PXZUpLUK/DivArvian-Userbot.git"
)
...
# Default .alive name
ALIVE_NAME = os.environ.get("ALIVE_NAME", "DivArvian")
...
INLINE_PIC = (
    os.environ.get("INLINE_PIC") or "https://telegra.ph/file/02ea84fc71d54b9c19a0b.jpg"
)
...
while 0 < 6:
    _BLACKLIST = get(
        "https://raw.githubusercontent.com/PXZUpLUK/Reforestation/master/manblacklist.json"
    )
...
while 0 < 6:
    _WHITELIST = get(
        "https://raw.githubusercontent.com/PXZUpLUK/Reforestation/master/whitelist.json"
    )
...
async def update_restart_msg(chat_id, msg_id):
    ...
    message = (
        f"**DivArvian-UserBot v{BOT_VER} is back up and running!**\n\n"
        ...
        async def inline_handler(event):
            ...
            if event.query.user_id == uid and query.startswith("@SharingUserbot"):
                ...
                result = builder.photo(
                    file=logoman,
                    link_preview=False,
                    text=f"**✗ DivArvian-Userbot Inline Menu ✗**\n\n✣ **Owner** [{user.first_name}](tg://user?id={user.id})\n✣ **Jumlah** `{len(dugmeler)}` Modules",
                    buttons=buttons,
                )
            elif query.startswith("repo"):
                result = builder.article(
                    title="Repository",
                    description="Repository DivArvian - Userbot",
                    url="https://t.me/SharingUserbot",
                    thumb=InputWebDocument(INLINE_PIC, 0, "image/jpeg", []),
                    text="**DivArvian - UserBot**\n➖➖➖➖➖➖➖➖➖➖\n✣ **Owner Repo :** [DivArvian](https://t.me/PXZUpLUK)\n✣ **Support :** @LieShooter_TG\n✣ **Repository :** [DivArvian-Userbot](https://github.com/PXZUpLUK/DivArvian-Userbot)\n➖➖➖➖➖➖➖➖➖➖",
                    buttons=[
                        [
                            custom.Button.url("ɢʀᴏᴜᴘ", "https://t.me/LieShooter_GC"),
                            custom.Button.url(
                                "ʀᴇᴘᴏ", "https://github.com/PXZUpLUK/DivArvian-Userbot"
                            ),
                        ],
                    ],
                    link_preview=False,
                ...
                result = builder.article(
                    title="✗ DivArvian-Userbot ✗",
                    description="DivArvian - UserBot | Telethon",
                    url="https://t.me/LieShooter_GC",
                    thumb=InputWebDocument(INLINE_PIC, 0, "image/jpeg", []),
                    text=f"**DivArvian - UserBot**\n➖➖➖➖➖➖➖➖➖➖\n✣ **UserMode:** [{user.first_name}](tg://user?id={user.id})\n✣ **Assistant:** {tgbotusername}\n➖➖➖➖➖➖➖➖➖➖\n**Support:** @LieShooter_TG\n➖➖➖➖➖➖➖➖➖➖",
                    buttons=[
                        [
                            custom.Button.url("ɢʀᴏᴜᴘ", "https://t.me/LieShooter_GC"),
                            custom.Button.url(
